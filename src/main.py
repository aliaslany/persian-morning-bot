...
from src.weather import get_tehran_weather
from src.prayer_times import get_tehran_prayer_times
...
def main():
    ...
    weather = get_tehran_weather()
    
    # 6. Get prayer times (Aladhan API)
    prayer_times = get_tehran_prayer_times()
