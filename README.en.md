# Persian Morning Telegram Bot (ربات صبح‌بخیر تلگرام)

*(نسخه‌ی فارسی این سند: [README.md](README.md) · Demo/order page: [GitHub Pages](https://aliaslany.github.io/persian-morning-bot/))*
